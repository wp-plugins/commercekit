...
/***********************************************************/
	...
	CommerceKitLib.USA_states_array = [
		{code: "AK", name: "Alaska"},
...
/***********************************************************/
	...
	CommerceKitLib.countries_array = [
...
/***********************************************************/
	...
	CommerceKitLib.currencies_array = [
	...
	// 			if (typeof(object.variableName) !== 'undefined') {
	// 				clearInterval(interval);
	// 				dfd.resolve();
	// 			}
	// 		}, 50);
	...
	CommerceKitLib.get_continent_of_country = function (country_name, callback) {

		for (var i = 0; i < CommerceKitLib.countries_array.length; i++) {
			if (CommerceKitLib.countries_array[i].name === country_name) {
				return CommerceKitLib.countries_array[i].continent;
			}
		}
